...
export type AdvantagesAccordionProps = {
  className?: string;
};

const AdvantagesAccordion: NextPage<AdvantagesAccordionProps> = ({
  className = "",
}) => {
  ...
  const items = [
    ...
    },
    {
      ...
      title: (
        <span>
          Делаем «как <br className="hidden max-[1350px]:block mq850:hidden" />
          на визуализации»
        </span>
      ),
    ...
    },
    {
      ...
      title: (
        <span>
          Работаем <br className="hidden max-[1350px]:block mq850:hidden" />
          «под ключ»
        </span>
      ),
