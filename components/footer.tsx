        ...
        >
          ...
          <div className="min-w-0 flex flex-col items-start gap-[25px] max-[480px]:gap-4">
            ...
            <div className="flex flex-col items-start gap-4 z-[1] text-gray-1600 max-[360px]:gap-3">
              {["УСЛУГИ", "ПРЕИМУЩЕСТВА", "ЭТАПЫ РАБОТ", "О НАС", "КЕЙСЫ"].map(
                (item) => (
                  <div
                    key={item}
                    className="relative leading-[140%] font-medium max-[360px]:text-[11px]"
                  >
                    {item}
                  </div>
                ),
            ...
            >
              ...
              >
                {[
                  ...
                  <div
                    key={item}
                    className="relative leading-[140%] font-medium max-[360px]:text-[12px]"
                  >
                    {item}
                  </div>
                ))}
