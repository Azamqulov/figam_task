...
const InfoCard: NextPage<InfoCardProps> = ({
  className = "",
  groupDivGap,
  frameDivMinWidth,
  prop,
    ...
    >
      ...
      >
        <div className="self-stretch flex-1 flex flex-col items-start gap-1">
          <h3 className="m-0 relative text-[22px] text-[length:inherit] tracking-num--0_02 leading-[140%] font-semibold font-inherit mq450:text-num-18 mq450:leading-num-25 ">
            {prop}
          </h3>
          <div
