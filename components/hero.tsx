...
const Hero: NextPage<HeroProps> = ({ className = "" }) => {
  return (
    <div
      className={`self-stretch flex flex-wrap items-start gap-2.5 max-w-full text-left text-num-22 text-black-brand font-libre-franklin mq1525:flex-wrap ${className}`}
    >
      <div className="flex flex-col items-start  gap-2.5 max-w-[730px] flex-1  h-[600px]  max-w-full max-[1326px]:min-w-full max-[1326px]:w-full max-[1326px]:flex-none">
        <section className="self-stretch rounded-num-30 bg-white flex flex-col  pt-[40.5px] px-[38px] pb-[50px] box-border gap-[29px] max-w-full text-left text-num-14 text-gray-2400 font-libre-franklin mq850:pt-num-26 mq850:pb-num-32 mq850:px-[20px] mq450:px-[15px] mq850:box-border">
          ...
          <div className="w-[190px] flex items-start pt-num-0 px-num-2 pb-num-31 box-border shrink-0 max-w-full">
            <div className="flex-1 flex flex-col items-start gap-[11.4px]">
              <Image
                ...
                src="/Group-104.svg"
              />
              <div className="relative text-[14px] font-medium leading-[130%] font-medium shrink-0 z-[1]">
                80% клиентов приходят <br />
                по рекомендациям
              </div>
            </div>
          </div>
          <div className="w-[613px] flex flex-col items-start gap-[25px] max-w-full shrink-0 text-num-11 text-gray-2200">
            <div className="w-[255px] h-num-25 flex items-start py-num-0 px-num-2 box-border max-w-full">
              <div className="self-stretch rounded-num-6 border-gray-2300 border-solid border-[1px] flex items-center justify-center flex-wrap content-center py-num-5 pl-num-9 pr-num-13 gap-[5px] max-w-full">
                ...
                <div className="relative leading-[130%] font-medium text-center">
          ...
          <div className="w-[541px] flex items-start py-num-0 px-num-2 box-border max-w-full shrink-0 text-num-22 text-gray-2100">
            <div className="flex-1 relative tracking-num--0_01 leading-[132%] font-medium inline-block max-w-full z-[1] mq450:text-num-18 mq450:leading-num-23 text-[22px]">
              <span className="font-medium text-[22px] font-medium ">{`Делаем так, чтобы вы открылись `}</span>
              <span className="text-pink-brand font-medium text-[22px] font-medium">{`вовремя и без переделок: `}</span>
          ...
          <div className="w-[469px] flex items-start py-num-0 px-num-2 box-border max-w-full shrink-0">
            <button className="cursor-pointer [border:none] py-num-10 px-5 bg-pink-brand min-h-[70px] h-auto flex-1 rounded-num-10 flex items-center justify-center box-border gap-2.5 max-w-full hover:bg-lightcoral-100">
              ...
              <Image
                className="h-num-15 w-num-19 relative shrink-0 mb-num-10"
                width={19}
                height={15}
                sizes="100vw"
                alt=""
      ...
      <div
        className="
    flex-1 rounded-num-20 bg-pink-brand 
      max-h-[740px]
    overflow-hidden
  ...
  "
    ...
    "
        ...
        <section
          className="
      flex-1 max-w-[525px] h-[640px] rounded-[13.9px] bg-white
